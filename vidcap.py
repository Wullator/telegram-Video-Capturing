#Дисклеймер: не будь мразью, не используй его для похищения чего-либо, используйте ИСКЛЮЧИТЕЛЬНО ДЛЯ ТЕСТИРОВАНИЯ ВАШЕЙ СИСТЕМЫ!!
#Разработчик не несет ответственности за ваши проделки в корыстных целях!
